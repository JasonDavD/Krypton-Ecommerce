# Spec: reportes — Exportable Admin Reports (Excel + PDF)

> SDD spec phase. Artifact store: hybrid (engram `sdd/reportes/spec` + this file).
> Grounded in: proposal `sdd/reportes/proposal` (#324) + exploration `sdd/reportes/explore` (#323).
> Change name: `reportes`. Capability: `reporting` (NEW).
...
*Spec written: 2026-06-08. Feeds: sdd-design + sdd-tasks.*
