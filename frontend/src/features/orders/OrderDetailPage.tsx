...
/** Agrupa de a 4 dígitos: "1234 5678 9012 3456". */
const formatCardNumber = (s: string) => onlyDigits(s).slice(0, 16).replace(/(.{4})(?=.)/g, '$1 ');
...
export function OrderDetailPage() {
  ...
  // Validación del formulario de pago simulado.
                  ...
                  <div className="od-payform__row">
                    ...
                    <label className="od-payform__field">
                      ...
                      <input
                        ...
                        placeholder="123"
                        maxLength={3}
                        onChange={(e) => setCardCvv(onlyDigits(e.target.value).slice(0, 3))}
                      />
                    </label>
                  </div>
                  <label className="od-payform__field">
